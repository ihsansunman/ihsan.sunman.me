...
export const RESUME_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      techStack: ["Side Project", "Kotlin", "Android"],
      description:
        "Trendyol Android Bootcamp 2021 Education Project. This is an expanding and individual project, each incoming assignment adds to the previous work. It is a shopping mobile application prepared for the Android platform with Kotlin language.",
    }
  ],
} as const;
